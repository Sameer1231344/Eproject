								...
								<ul class="list-unstyled">
									...
									<li class="drop"><a href="#">Pages</a>
										<ul class="drop-down">
											...
											<li><a href="blog_left.php">Blog left</a></li>
											<li><a href="blog_right.php">Blog right</a></li>
											<li><a href="blog_single.php">Single blog</a></li>
											<li><a href="contact.php">Contact us</a></li>
											<li><a href="product_single.php">Product single</a></li>
											<li><a href="shopping_cart.php">Cart page</a></li>
										</ul>
									</li>
									...
									<div class="slider-flr" id="filter_itm1">
							    		<div class="js-filter-chicken">
							    			<div class="block-stl2">
							    				...
							    				<div class="btn-sec">
						    						<a href="product_single.php" class="btn4">About More</a>
						    						<a href="shopping_cart.php" class="btn1 stl2">Add to Cart</a>
					    						</div>
							    			</div>
							    		</div>
							    		<div class="js-filter-chicken">
					...
					<div class="grid1">
						<div class="block-stl3 stl1">
							...
							<div class="offer-block">
								...
								<a href="shopping_cart.php" class="btn3">shop now</a>
					...
					<div class="col-lg-12">
						<div class="blog-slider1 owl-theme owl-carousel">
							<div class="item">
								<div class="blog-stl1">
									<div class="img-holder">
										<img src="images/boy.jpg" alt="" class="img-responsive" />
							...
							<div class="item">
								<div class="blog-stl1">
									<div class="img-holder">
										<img src="images/girl.jpg" alt="" class="img-responsive" />
										<div class="ovrl-block">
											<h3>Donec leo metus placerat quis lorem sed ultricies bibendum metus.</h3>
											<a href="blog_single.html" class="btn1 stl2">read more</a>
										</div>
							...
							<div class="item">
								<div class="blog-stl1">
									<div class="img-holder">
										<img src="images/girl1.jpg" alt="" class="img-responsive" />
										<div class="ovrl-block">
											<h3>Donec leo metus placerat quis lorem sed ultricies bibendum metus.</h3>
											<a href="blog_single.html" class="btn1 stl2">read more</a>
										</div>
							...
							<div class="item">
								<div class="blog-stl1">
									<div class="img-holder">
										<img src="images/girl2.jpg" alt="" class="img-responsive" />
										<div class="ovrl-block">
											<h3>Donec leo metus placerat quis lorem sed ultricies bibendum metus.</h3>
											<a href="blog_single.html" class="btn1 stl2">read more</a>
										</div>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
						<div class="flickr">
							...
							<div class="footer-content">
								<ul class="list-unstyled">
									<li><a href="#"><img src="images/Layer-12.jpg" alt="" class="img-responsive"></a></li>
									<li><a href="#"><img src="images/Layer-13.jpg" alt="" class="img-responsive"></a></li>
									<li><a href="#"><img src="images/Layer-14.jpg" alt="" class="img-responsive"></a></li>
									<li><a href="#"><img src="images/Layer-15.jpg" alt="" class="img-responsive"></a></li>
									<li><a href="#"><img src="images/Layer-16.png" alt="" class="img-responsive"></a></li>
									<li><a href="#"><img src="images/Layer-17.jpg" alt="" class="img-responsive"></a></li>
									<li><a href="#"><img src="images/Layer-18.jpg" alt="" class="img-responsive"></a></li>
									<li><a href="#"><img src="images/Layer-19.jpg" alt="" class="img-responsive"></a></li>
								</ul>
							</div>
						</div>
					</div>
